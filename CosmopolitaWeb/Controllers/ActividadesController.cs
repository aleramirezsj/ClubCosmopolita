...
namespace CosmopolitaWeb.Controllers
{
    public class ActividadesController : Controller
    {
        ...
        public ActividadesController(CosmopolitaWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Horarios,Costo")] Actividad actividad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Horarios,Costo")] Actividad actividad)
        {
            if (id != actividad.Id)
            {
                return NotFound();
