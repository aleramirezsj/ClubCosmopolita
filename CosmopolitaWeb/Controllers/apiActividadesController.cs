...
namespace CosmopolitaWeb.Controllers
{
    ...
    [ApiController]
    public class apiActividadesController : ControllerBase
    {
        private readonly CosmopolitaWebContext _context;

        public apiActividadesController(CosmopolitaWebContext context)
        {
            _context = context;
        }

        // GET: api/apiActividades
        [HttpGet]
